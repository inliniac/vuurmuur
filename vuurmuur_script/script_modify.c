...
int
script_modify(VuurmuurScript *vr_script)
{
    char    found = FALSE;
    int     result = 0;
    ...
    */
    result = backend_check(vr_script->type, vr_script->var, vr_script->set, vr_script->overwrite, &vr_script->vctx.reg);
    if(result != 0)
        return(result);
    ...
    */
    if(vr_script->type == VRMR_TYPE_ZONE)
    {
        if(vr_script->vctx.zf->tell(vr_script->vctx.zone_backend, vr_script->name, vr_script->var, vr_script->set, vr_script->overwrite, VRMR_TYPE_ZONE) < 0)
        {
    ...
    {
        if(vr_script->vctx.zf->tell(vr_script->vctx.zone_backend, vr_script->name, vr_script->var, vr_script->set, vr_script->overwrite, VRMR_TYPE_NETWORK) < 0)
        {
    ...
    {
        if(vr_script->vctx.zf->tell(vr_script->vctx.zone_backend, vr_script->name, vr_script->var, vr_script->set, vr_script->overwrite, VRMR_TYPE_HOST) < 0)
        {
    ...
    {
        if(vr_script->vctx.zf->tell(vr_script->vctx.zone_backend, vr_script->name, vr_script->var, vr_script->set, vr_script->overwrite, VRMR_TYPE_GROUP) < 0)
        {
    ...
    {
        if(vr_script->vctx.sf->tell(vr_script->vctx.serv_backend, vr_script->name, vr_script->var, vr_script->set, vr_script->overwrite, VRMR_TYPE_SERVICE) < 0)
        {
    ...
    {
        if(vr_script->vctx.af->tell(vr_script->vctx.ifac_backend, vr_script->name, vr_script->var, vr_script->set, vr_script->overwrite, VRMR_TYPE_INTERFACE) < 0)
        {
    ...
    {
        if(vr_script->vctx.rf->tell(vr_script->vctx.rule_backend, vr_script->name, vr_script->var, vr_script->set, vr_script->overwrite, VRMR_TYPE_RULE) < 0)
        {
