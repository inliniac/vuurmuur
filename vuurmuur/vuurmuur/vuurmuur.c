                    ...
                    &option_index)) != -1 )
    {
        switch(optch)
        {
            ...
            case 'b' :
                ...
                fprintf(stdout, "# Firewall generated by Vuurmuur %s, Copyright (C) 2002-2007 by Victor Julien\n",
                                                        version_string);
...
//TODO: do an options sanity check (eg. bash and loop dont play together)
    ...
    /* check for the version of the library */
    result = vuurmuur_check_lib_version(debuglvl, VUURMUUR_VERSION_MAJOR, VUURMUUR_VERSION_MINOR, VUURMUUR_VERSION_SUB, MIN_LIBVUURMUUR_VERSION_MAJOR, MIN_LIBVUURMUUR_VERSION_MINOR, MIN_LIBVUURMUUR_VERSION_SUB);
    if(result < 0)
        exit(EXIT_FAILURE);
    ...
    (void)vrprint.info("Info", "Copyright (C) 2002-2007 by Victor Julien");
