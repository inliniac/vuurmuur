...
#define STR_IP6NETWORK gettext("IPv6 network")
#define STR_IP6CIDR gettext("IPv6 cidr")
...
#define STR_TCPMSS gettext("Tcpmss")

/* TRANSLATORS: "interface 'lan' has been changed: rules are changed: number of
 * rules: 5 (listed below)." */
...
#define STR_ONLY_ASCII_ALLOWED_IN_PREFIX                                       \
    gettext("only ASCII is allowed in the prefix field.")

/*
    audit strings
*/
/* TRANSLATORS: example: service 'http' has been changed: active is now set to
 * 'Yes' (was: 'No'). */
#define STR_HAS_BEEN_CHANGED gettext("has been changed")
/* TRANSLATORS: example: service 'http' has been changed: portrange 'TCP:
 * 1024:65535->80' has been added. */
...
/* TRANSLATORS: example: service 'http' has been changed: portrange 'TCP:
 * 1024:65535->80' has been removed. */
...
/* TRANSLATORS: example: service '%s' has been changed: the comment has been
 * changed. */
...
/*
    blocklist
*/
#define STR_HAS_BEEN_ADDED_TO_THE_BLOCKLIST                                    \
    gettext("has been added to the blocklist")
#define STR_HAS_BEEN_REMOVED_FROM_THE_BLOCKLIST                                \
    gettext("has been added to the blocklist")
...
#define STR_LOAD_VUURMUUR_CONF_SETTINGS                                        \
    gettext("Loading Vuurmuur_conf settings")
...
#define STR_LOGGING_OPTS_NOT_AVAIL                                             \
    gettext("logging options are only available for the traffic.log.")

/*
    edit rule
*/
#define STR_BOUNCE_REQUIRES_VIA_OPT                                            \
    gettext("the action 'Bounce' requires the 'via' option to be set.")
#define STR_REDIRECT_REQUIRES_OPT                                              \
